package com.swork.checklist.rest.client.resource.v1_0;
...
public interface CheckListResource {
	...
	public HttpInvoker.HttpResponse getCheckListByIdHttpResponse(Long cid)
		throws Exception;

	public CheckList updateCheckList(Long cid, CheckList checkList)
		throws Exception;

	public HttpInvoker.HttpResponse updateCheckListHttpResponse(
			Long cid, CheckList checkList)
		throws Exception;
	...
	public static class CheckListResourceImpl implements CheckListResource {
		...
		public Page<CheckList> getChecklists() throws Exception {
			...
			try {
				return Page.of(content, CheckListSerDes::toDTO);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
		...
		public CheckList postCheckList(CheckList checkList) throws Exception {
			HttpInvoker.HttpResponse httpResponse = postCheckListHttpResponse(
				checkList);
			...
			try {
				return CheckListSerDes.toDTO(content);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
		...
		public HttpInvoker.HttpResponse postCheckListHttpResponse(
			...
			httpInvoker.body(checkList.toString(), "application/json");
		...
		public void deleteCheckList(Long cid) throws Exception {
			HttpInvoker.HttpResponse httpResponse = deleteCheckListHttpResponse(
				cid);
		...
		public CheckList getCheckListById(Long cid) throws Exception {
			HttpInvoker.HttpResponse httpResponse =
				getCheckListByIdHttpResponse(cid);
		...
		public CheckList updateCheckList(Long cid, CheckList checkList)
			...
			HttpInvoker.HttpResponse httpResponse = updateCheckListHttpResponse(
				cid, checkList);
