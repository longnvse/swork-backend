package com.swork.checklist.rest.dto.v1_0;
 ...
 */
@Generated("")
@GraphQLName("CheckList")
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "CheckList")
public class CheckList implements Serializable {

	public static CheckList toDTO(String json) {
		return ObjectMapperUtil.readValue(CheckList.class, json);
	}

	public static CheckList unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(CheckList.class, json);
	}
	...
	@Schema(
		...
		defaultValue = "com.swork.checklist.rest.dto.v1_0.CheckList",
		name = "x-class-name"
	)
