...
public abstract class BaseCheckListResourceImpl
	implements CheckListResource, EntityModelResource,
			   VulcanBatchEngineTaskItemDelegate<CheckList> {
	...
	@Override
	public Response postCheckListBatch(
		...
		return responseBuilder.entity(
			vulcanBatchEngineImportTaskResource.postImportTask(
				CheckList.class.getName(), callbackURL, null, object)
		).build();
	}
	...
	public Response deleteCheckListBatch(
		...
		return responseBuilder.entity(
			vulcanBatchEngineImportTaskResource.deleteImportTask(
				CheckList.class.getName(), callbackURL, object)
		).build();
	}
	...
	public void create(
			java.util.Collection<CheckList> checkLists,
			Map<String, Serializable> parameters)
		throws Exception {

		UnsafeConsumer<CheckList, Exception> checkListUnsafeConsumer =
			checkList -> postCheckList(checkList);

		for (CheckList checkList : checkLists) {
			checkListUnsafeConsumer.accept(checkList);
		}
	}
	...
	public void delete(
		...
		for (CheckList checkList : checkLists) {
			deleteCheckList(checkList.getCheckListId());
		}
	}
