...
/**
 * Provides the local service utility for WorkMemberEntry. This utility wraps
 * <code>com.swork.core.work.service.service.impl.WorkMemberEntryLocalServiceImpl</code> and
 ...
 * @generated
 */
public class WorkMemberEntryLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.swork.core.work.service.service.impl.WorkMemberEntryLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	public static WorkMemberEntry addWorkMemberEntry(
		long workId,
		com.swork.core.work.service.mapper.model.WorkMemberMapperModel model,
		String type) {

		return getService().addWorkMemberEntry(workId, model, type);
	}
	 ...
	 */
	public static WorkMemberEntry createWorkMemberEntry(long workMemberId) {
		return getService().createWorkMemberEntry(workMemberId);
	}

	public static void deleteByWorkId(long workId) {
		getService().deleteByWorkId(workId);
	}
	 ...
	 */
	public static WorkMemberEntry deleteWorkMemberEntry(long workMemberId)
		throws PortalException {

		return getService().deleteWorkMemberEntry(workMemberId);
	}
	 ...
	 * @return the work member entry that was removed
	 */
	public static WorkMemberEntry deleteWorkMemberEntry(
		WorkMemberEntry workMemberEntry) {

		return getService().deleteWorkMemberEntry(workMemberEntry);
	}
	...
	public static WorkMemberEntry fetchWorkMemberEntry(long workMemberId) {
		return getService().fetchWorkMemberEntry(workMemberId);
	}

	public static List<WorkMemberEntry> findByW_MT_T(
		long workId, String memberType, String type) {

		return getService().findByW_MT_T(workId, memberType, type);
	}

	public static List<WorkMemberEntry> findByW_T(long workId, String type) {
		return getService().findByW_T(workId, type);
	}
	 ...
	 */
	public static List<WorkMemberEntry> getWorkMemberEntries(
		int start, int end) {

		return getService().getWorkMemberEntries(start, end);
	}
	 ...
	 */
	public static int getWorkMemberEntriesCount() {
		return getService().getWorkMemberEntriesCount();
	}
	 ...
	 * @throws PortalException if a work member entry with the primary key could not be found
	 */
	public static WorkMemberEntry getWorkMemberEntry(long workMemberId)
		throws PortalException {

		return getService().getWorkMemberEntry(workMemberId);
	}
	 ...
	 */
	public static WorkMemberEntry updateWorkMemberEntry(
		WorkMemberEntry workMemberEntry) {

		return getService().updateWorkMemberEntry(workMemberEntry);
	}

	public static WorkMemberEntryLocalService getService() {
		return _service;
	}

	private static volatile WorkMemberEntryLocalService _service;
