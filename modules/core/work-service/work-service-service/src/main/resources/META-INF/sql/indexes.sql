create index IX_A0D52AB9 on SW_Work (businessId, parentId, name[$COLUMN_LENGTH:75$]);
...
create index IX_6DF7702 on SW_Work (businessId, projectId, phaseId, name[$COLUMN_LENGTH:75$]);
create index IX_76527087 on SW_Work (companyId, externalReferenceCode[$COLUMN_LENGTH:75$]);
create index IX_7C330B0A on SW_Work (parentId, name[$COLUMN_LENGTH:75$]);
create index IX_8CC370B on SW_Work (parentReferenceCode[$COLUMN_LENGTH:75$], name[$COLUMN_LENGTH:75$]);
create index IX_6F2328F4 on SW_Work (phaseId);
create index IX_FECF62D1 on SW_Work (projectId, name[$COLUMN_LENGTH:75$]);
