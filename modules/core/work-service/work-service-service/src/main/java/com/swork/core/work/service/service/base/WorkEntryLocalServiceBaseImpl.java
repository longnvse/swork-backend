...
/**
 * Provides the base implementation for the work entry local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.swork.core.work.service.service.impl.WorkEntryLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.swork.core.work.service.service.impl.WorkEntryLocalServiceImpl
 * @generated
 */
public abstract class WorkEntryLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService, WorkEntryLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>WorkEntryLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>WorkEntryLocalServiceUtil</code>.
	 */
	...
	public WorkEntry addWorkEntry(WorkEntry workEntry) {
		...
		return workEntryPersistence.update(workEntry);
	}
	...
	public WorkEntry createWorkEntry(long workId) {
		return workEntryPersistence.create(workId);
	}
	...
	public WorkEntry deleteWorkEntry(long workId) throws PortalException {
		return workEntryPersistence.remove(workId);
	}
	...
	public WorkEntry deleteWorkEntry(WorkEntry workEntry) {
		return workEntryPersistence.remove(workEntry);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return workEntryPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			WorkEntry.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return workEntryPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return workEntryPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return workEntryPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return workEntryPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public WorkEntry fetchWorkEntry(long workId) {
		return workEntryPersistence.fetchByPrimaryKey(workId);
	}
	...
	public WorkEntry fetchWorkEntryByUuidAndGroupId(String uuid, long groupId) {
		return workEntryPersistence.fetchByUUID_G(uuid, groupId);
	}
	...
	public WorkEntry fetchWorkEntryByExternalReferenceCode(
		...
		return workEntryPersistence.fetchByC_ERC(
	...
	public WorkEntry fetchWorkEntryByReferenceCode(
		...
		return fetchWorkEntryByExternalReferenceCode(
			companyId, externalReferenceCode);
	}
	...
	public WorkEntry getWorkEntryByExternalReferenceCode(
		...
		return workEntryPersistence.findByC_ERC(
			companyId, externalReferenceCode);
	}
	...
	public WorkEntry getWorkEntry(long workId) throws PortalException {
		return workEntryPersistence.findByPrimaryKey(workId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(workEntryLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(WorkEntry.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("workId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setBaseLocalService(
			workEntryLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(WorkEntry.class);

		indexableActionableDynamicQuery.setPrimaryKeyPropertyName("workId");
	...
	public ExportActionableDynamicQuery getExportActionableDynamicQuery(
		...
		exportActionableDynamicQuery.setPerformActionMethod(
			new ActionableDynamicQuery.PerformActionMethod<WorkEntry>() {

				@Override
				public void performAction(WorkEntry workEntry)
					throws PortalException {

					StagedModelDataHandlerUtil.exportStagedModel(
						portletDataContext, workEntry);
				}
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return workEntryPersistence.create(((Long)primaryKeyObj).longValue());
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return workEntryLocalService.deleteWorkEntry((WorkEntry)persistedModel);
	}

	@Override
	public BasePersistence<WorkEntry> getBasePersistence() {
		return workEntryPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return workEntryPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<WorkEntry> getWorkEntriesByUuidAndCompanyId(
		...
		return workEntryPersistence.findByUuid_C(uuid, companyId);
	}
	...
	public List<WorkEntry> getWorkEntriesByUuidAndCompanyId(
		...
		return workEntryPersistence.findByUuid_C(
	...
	public WorkEntry getWorkEntryByUuidAndGroupId(String uuid, long groupId)
		...
		return workEntryPersistence.findByUUID_G(uuid, groupId);
	}
	...
	public List<WorkEntry> getWorkEntries(int start, int end) {
		return workEntryPersistence.findAll(start, end);
	}
	...
	public int getWorkEntriesCount() {
		return workEntryPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			WorkEntryLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		workEntryLocalService = (WorkEntryLocalService)aopProxy;

		_setLocalServiceUtilService(workEntryLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return WorkEntryLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = workEntryPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field = WorkEntryLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, workEntryLocalService);
		}
	...
	protected WorkEntryLocalService workEntryLocalService;
