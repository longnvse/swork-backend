...
@Generated("")
@OpenAPIDefinition(
	info = @Info(description = "ProjectRest REST API", license = @License(name = "Apache 2.0", url = "http://www.apache.org/licenses/LICENSE-2.0.html"), title = "ProjectRest", version = "v1.0")
)
@Path("/v1.0")
