 ...
 */
@Generated("")
@GraphQLName(description = "Present chart", value = "ValueArrayString")
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "ValueArrayString")
public class ValueArrayString implements Serializable {

	public static ValueArrayString toDTO(String json) {
		return ObjectMapperUtil.readValue(ValueArrayString.class, json);
	}

	public static ValueArrayString unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(ValueArrayString.class, json);
	}
	...
	@Schema(
		...
		defaultValue = "com.swork.core.project.rest.dto.v1_0.ValueArrayString",
		name = "x-class-name"
	)
