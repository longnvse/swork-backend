 ...
 */
@Generated("")
@GraphQLName(description = "Present chart", value = "ValueChart")
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "ValueChart")
public class ValueChart implements Serializable {

	public static ValueChart toDTO(String json) {
		return ObjectMapperUtil.readValue(ValueChart.class, json);
	}

	public static ValueChart unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(ValueChart.class, json);
	}
	...
	@Schema(
		...
		defaultValue = "com.swork.core.project.rest.dto.v1_0.ValueChart",
		name = "x-class-name"
	)
