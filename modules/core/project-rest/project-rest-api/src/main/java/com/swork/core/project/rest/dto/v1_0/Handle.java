 ...
 */
@Generated("")
@GraphQLName(description = "Project Handles", value = "Handle")
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "Handle")
public class Handle implements Serializable {

	public static Handle toDTO(String json) {
		return ObjectMapperUtil.readValue(Handle.class, json);
	}

	public static Handle unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(Handle.class, json);
	}
	...
	@Schema(
		...
		defaultValue = "com.swork.core.project.rest.dto.v1_0.Handle",
		name = "x-class-name"
	)
