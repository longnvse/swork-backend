package com.swork.core.project.rest.resource.v1_0;
 ...
 *
 *     curl -u your@email.com:yourpassword -D - http://localhost:8080/o/swork/project-rest/v1.0
 *
 * @author Long Hip
 * @generated
 */
...
public interface ProjectResource {
	...
	public Page<Project> getProjectsPage(
			String type, String search, Filter filter, Pagination pagination,
			Sort[] sorts)
		throws Exception;

	public Project postProject(Project project) throws Exception;

	public Response postProjectBatch(String callbackURL, Object object)
		throws Exception;

	public void deleteProject(Long projectId) throws Exception;

	public Response deleteProjectBatch(String callbackURL, Object object)
		throws Exception;
