...
public class HandleSerDes {
	...
	public static String toJSON(Handle handle) {
		...
		if (handle.getMemberType() != null) {
			...
			sb.append(handle.getMemberType());
	...
	public static Map<String, String> toMap(Handle handle) {
		...
		if (handle.getMemberType() == null) {
			map.put("memberType", null);
		}
		else {
			map.put("memberType", String.valueOf(handle.getMemberType()));
		}
	...
	public static class HandleJSONParser extends BaseJSONParser<Handle> {
		...
		protected void setField(
			...
			else if (Objects.equals(jsonParserFieldName, "memberType")) {
				if (jsonParserFieldValue != null) {
					handle.setMemberType(
						Handle.MemberType.create((String)jsonParserFieldValue));
				}
			}
		}
