...
public class ParticipateSerDes {
	...
	public static String toJSON(Participate participate) {
		...
		if (participate.getMemberType() != null) {
			if (sb.length() > 1) {
				sb.append(", ");
			}
			...
			sb.append(participate.getMemberType());
	...
	public static Map<String, String> toMap(Participate participate) {
		...
		if (participate.getMemberType() == null) {
			...
			map.put("memberType", String.valueOf(participate.getMemberType()));
		}
	...
	public static class ParticipateJSONParser
		...
		protected void setField(
			...
			if (Objects.equals(jsonParserFieldName, "id")) {
				...
				if (jsonParserFieldValue != null) {
					participate.setMemberType(
						Participate.MemberType.create(
							(String)jsonParserFieldValue));
				}
			}
		}
