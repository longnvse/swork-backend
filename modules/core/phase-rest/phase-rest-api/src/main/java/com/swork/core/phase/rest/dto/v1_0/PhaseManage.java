 ...
 */
@Generated("")
@GraphQLName(description = "PhaseManage Model", value = "PhaseManage")
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "PhaseManage")
public class PhaseManage implements Serializable {

	public static PhaseManage toDTO(String json) {
		return ObjectMapperUtil.readValue(PhaseManage.class, json);
	}

	public static PhaseManage unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(PhaseManage.class, json);
	}
	...
	@Schema(
		...
		defaultValue = "com.swork.core.phase.rest.dto.v1_0.PhaseManage",
		name = "x-class-name"
	)
