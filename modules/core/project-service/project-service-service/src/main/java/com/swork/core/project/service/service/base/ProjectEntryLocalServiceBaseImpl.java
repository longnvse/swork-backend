...
/**
 * Provides the base implementation for the project entry local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.swork.core.project.service.service.impl.ProjectEntryLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.swork.core.project.service.service.impl.ProjectEntryLocalServiceImpl
 * @generated
 */
public abstract class ProjectEntryLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService, ProjectEntryLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ProjectEntryLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>ProjectEntryLocalServiceUtil</code>.
	 */
	...
	public ProjectEntry addProjectEntry(ProjectEntry projectEntry) {
		...
		return projectEntryPersistence.update(projectEntry);
	}
	...
	public ProjectEntry createProjectEntry(long projectId) {
		return projectEntryPersistence.create(projectId);
	}
	...
	public ProjectEntry deleteProjectEntry(long projectId)
		...
		return projectEntryPersistence.remove(projectId);
	}
	...
	public ProjectEntry deleteProjectEntry(ProjectEntry projectEntry) {
		return projectEntryPersistence.remove(projectEntry);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return projectEntryPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			ProjectEntry.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return projectEntryPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return projectEntryPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return projectEntryPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return projectEntryPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public ProjectEntry fetchProjectEntry(long projectId) {
		return projectEntryPersistence.fetchByPrimaryKey(projectId);
	}
	...
	public ProjectEntry getProjectEntry(long projectId) throws PortalException {
		return projectEntryPersistence.findByPrimaryKey(projectId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(projectEntryLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(ProjectEntry.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setBaseLocalService(
			projectEntryLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(ProjectEntry.class);
	...
	public ExportActionableDynamicQuery getExportActionableDynamicQuery(
		...
		exportActionableDynamicQuery.setPerformActionMethod(
			new ActionableDynamicQuery.PerformActionMethod<ProjectEntry>() {

				@Override
				public void performAction(ProjectEntry projectEntry)
					throws PortalException {

					StagedModelDataHandlerUtil.exportStagedModel(
						portletDataContext, projectEntry);
				}
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return projectEntryPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return projectEntryLocalService.deleteProjectEntry(
			(ProjectEntry)persistedModel);
	}

	@Override
	public BasePersistence<ProjectEntry> getBasePersistence() {
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return projectEntryPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<ProjectEntry> getProjectEntriesByUuidAndCompanyId(
		...
		return projectEntryPersistence.findByUuid_C(uuid, companyId);
	}
	...
	public List<ProjectEntry> getProjectEntriesByUuidAndCompanyId(
		...
		return projectEntryPersistence.findByUuid_C(
	...
	public ProjectEntry getProjectEntryByUuidAndGroupId(
		...
		return projectEntryPersistence.findByUUID_G(uuid, groupId);
	}
	...
	public List<ProjectEntry> getProjectEntries(int start, int end) {
		return projectEntryPersistence.findAll(start, end);
	}
	...
	public int getProjectEntriesCount() {
		return projectEntryPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			ProjectEntryLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		projectEntryLocalService = (ProjectEntryLocalService)aopProxy;

		_setLocalServiceUtilService(projectEntryLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return ProjectEntryLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = projectEntryPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field = ProjectEntryLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, projectEntryLocalService);
		}
