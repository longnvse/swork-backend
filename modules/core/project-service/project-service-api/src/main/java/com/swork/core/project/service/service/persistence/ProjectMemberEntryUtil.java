...
public class ProjectMemberEntryUtil {
	 ...
	 * @return the matching project member entries
	 */
	public static List<ProjectMemberEntry> findByP_T_(
		long projectId, String type) {

		return getPersistence().findByP_T_(projectId, type);
	}
	...
	public static List<ProjectMemberEntry> findByP_T_(
		...
		return getPersistence().findByP_T_(projectId, type, start, end);
	}
	...
	public static List<ProjectMemberEntry> findByP_T_(
		...
		return getPersistence().findByP_T_(
	...
	public static List<ProjectMemberEntry> findByP_T_(
		...
		return getPersistence().findByP_T_(
			projectId, type, start, end, orderByComparator, useFinderCache);
	}
	 ...
	 * @throws NoSuchProjectMemberEntryException if a matching project member entry could not be found
	 */
	public static ProjectMemberEntry findByP_T__First(
			long projectId, String type,
			OrderByComparator<ProjectMemberEntry> orderByComparator)
		throws com.swork.core.project.service.exception.
			NoSuchProjectMemberEntryException {

		return getPersistence().findByP_T__First(
	 ...
	 * @return the first matching project member entry, or <code>null</code> if a matching project member entry could not be found
	 */
	public static ProjectMemberEntry fetchByP_T__First(
		long projectId, String type,
		OrderByComparator<ProjectMemberEntry> orderByComparator) {

		return getPersistence().fetchByP_T__First(
			projectId, type, orderByComparator);
	}
	 ...
	 * @throws NoSuchProjectMemberEntryException if a matching project member entry could not be found
	 */
	public static ProjectMemberEntry findByP_T__Last(
			long projectId, String type,
			OrderByComparator<ProjectMemberEntry> orderByComparator)
		throws com.swork.core.project.service.exception.
			NoSuchProjectMemberEntryException {

		return getPersistence().findByP_T__Last(
			projectId, type, orderByComparator);
	}
	 ...
	 * @return the last matching project member entry, or <code>null</code> if a matching project member entry could not be found
	 */
	public static ProjectMemberEntry fetchByP_T__Last(
		long projectId, String type,
		OrderByComparator<ProjectMemberEntry> orderByComparator) {

		return getPersistence().fetchByP_T__Last(
			projectId, type, orderByComparator);
	}
	 ...
	 * @throws NoSuchProjectMemberEntryException if a project member entry with the primary key could not be found
	 */
	public static ProjectMemberEntry[] findByP_T__PrevAndNext(
			long projectMemberId, long projectId, String type,
			OrderByComparator<ProjectMemberEntry> orderByComparator)
		throws com.swork.core.project.service.exception.
			NoSuchProjectMemberEntryException {

		return getPersistence().findByP_T__PrevAndNext(
			projectMemberId, projectId, type, orderByComparator);
	}
	 ...
	 * @param type the type
	 */
	public static void removeByP_T_(long projectId, String type) {
		getPersistence().removeByP_T_(projectId, type);
	}
	 ...
	 * @return the number of matching project member entries
	 */
	public static int countByP_T_(long projectId, String type) {
		return getPersistence().countByP_T_(projectId, type);
	}
