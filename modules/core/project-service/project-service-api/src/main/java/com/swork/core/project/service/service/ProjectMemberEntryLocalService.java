...
/**
 * Provides the local service interface for ProjectMemberEntry. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see ProjectMemberEntryLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface ProjectMemberEntryLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.swork.core.project.service.service.impl.ProjectMemberEntryLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the project member entry local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link ProjectMemberEntryLocalServiceUtil} if injection and service tracking are not available.
	 */
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<ProjectMemberEntry> getProjectMemberEntries(int start, int end);
