package com.swork.core.work.rest.resource.v1_0;
 ...
 *
 *     curl -u your@email.com:yourpassword -D - http://localhost:8080/o/swork/work-rest/v1.0
 *
 * @author longnv
 * @generated
 */
...
public interface WorkResource {
	...
	public Response postWorkBatch(String callbackURL, Object object)
		throws Exception;

	public void deleteWork(Long workId) throws Exception;

	public Response deleteWorkBatch(String callbackURL, Object object)
		throws Exception;
