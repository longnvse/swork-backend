 ...
 */
@Generated("")
@GraphQLName(description = "Work Participate Model", value = "Manage")
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "Manage")
public class Manage implements Serializable {

	public static Manage toDTO(String json) {
		return ObjectMapperUtil.readValue(Manage.class, json);
	}

	public static Manage unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(Manage.class, json);
	}
	...
	@Schema(
		...
		defaultValue = "com.swork.core.work.rest.dto.v1_0.Manage",
		name = "x-class-name"
	)
