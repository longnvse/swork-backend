...
/**
 * Provides the local service interface for TeamMemberEntry. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see TeamMemberEntryLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface TeamMemberEntryLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.swork.core.resource.service.service.impl.TeamMemberEntryLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the team member entry local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link TeamMemberEntryLocalServiceUtil} if injection and service tracking are not available.
	 */
	@Indexable(type = IndexableType.REINDEX)
	public TeamMemberEntry addTeamMemberEntries(
		long companyId, long teamId, TeamMemberMapperModel model,
		boolean isAdmin);

	public void addTeamMemberEntries(
		long companyId, long teamId, TeamMembersMapperModel models,
		boolean isAdmin);
	...
	public void updateTeamMemberEntries(
		long companyId, long teamId, TeamMembersMapperModel model,
		boolean isAdmin);
