...
/**
 * The persistence interface for the resource entry service.
 *
 * <p>
 ...
 * @see ResourceEntryUtil
 * @generated
 */
@ProviderType
public interface ResourceEntryPersistence
	extends BasePersistence<ResourceEntry> {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ResourceEntryUtil} to access the resource entry persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this interface.
	 */
	 ...
	 */
	public java.util.List<ResourceEntry> findByUuid(String uuid);
	 ...
	 */
	public java.util.List<ResourceEntry> findByUuid(
	...
	public java.util.List<ResourceEntry> findByUuid(
		String uuid, int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<ResourceEntry>
			orderByComparator);
	 ...
	 * @return the matching resource entries
	 */
	public java.util.List<ResourceEntry> findByUuid_C(
	 ...
	 * @return the matching resource entries
	 */
	public java.util.List<ResourceEntry> findByB_W(
	 ...
	 * @return the matching resource entries
	 */
	public java.util.List<ResourceEntry> findByB_PH(
	 ...
	 * @return the matching resource entries
	 */
	public java.util.List<ResourceEntry> findByB_P(
	 ...
	 * @return the matching resource entries
	 */
	public java.util.List<ResourceEntry> findByB_Team(
	 ...
	 * @return the matching resource entries
	 */
	public java.util.List<ResourceEntry> findByB_W_PH_P(
	 ...
	 */
	public void cacheResult(java.util.List<ResourceEntry> resourceEntries);
	 ...
	 */
	public java.util.List<ResourceEntry> findAll();
	 ...
	 */
	public java.util.List<ResourceEntry> findAll(int start, int end);
