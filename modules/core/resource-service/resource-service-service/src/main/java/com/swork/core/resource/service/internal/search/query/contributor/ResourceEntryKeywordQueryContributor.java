...
public class ResourceEntryKeywordQueryContributor implements KeywordQueryContributor {
    ...
    public void contribute(String keywords,
        ...
        queryHelper.addSearchTerm(
                booleanQuery, searchContext, SearchFields.RESOURCE_TYPE_NAME, false);
        queryHelper.addSearchTerm(
                booleanQuery, searchContext, SearchFields.TEAM_NAME, false);
    }
