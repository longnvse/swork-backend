...
public class ResourceEntryModelDocumentContributor
    ...
    public void contribute(Document document, ResourceEntry baseModel) {
        ...
        document.addNumber(SearchFields.RESOURCE_TYPE_ID, baseModel.getResourceTypeId());
        document.addNumberSortable(SearchFields.RESOURCE_TYPE_ID, baseModel.getResourceTypeId());
