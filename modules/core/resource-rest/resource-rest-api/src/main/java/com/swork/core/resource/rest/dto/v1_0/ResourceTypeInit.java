 ...
 */
@Generated("")
@GraphQLName(description = "InitData by customer", value = "ResourceTypeInit")
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "ResourceTypeInit")
public class ResourceTypeInit implements Serializable {

	public static ResourceTypeInit toDTO(String json) {
		return ObjectMapperUtil.readValue(ResourceTypeInit.class, json);
	}

	public static ResourceTypeInit unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(ResourceTypeInit.class, json);
	}
	...
	public String toString() {
		...
		if (resourceTypes != null) {
			...
			for (int i = 0; i < resourceTypes.length; i++) {
				sb.append(String.valueOf(resourceTypes[i]));

				if ((i + 1) < resourceTypes.length) {
					sb.append(", ");
				}
			}
	...
	@Schema(
		...
		defaultValue = "com.swork.core.resource.rest.dto.v1_0.ResourceTypeInit",
		name = "x-class-name"
	)
