 ...
 */
@Generated("")
@GraphQLName(description = "ResourceType Model", value = "ResourceType")
...
public class ResourceType implements Serializable {
	...
	@Schema(description = "ResourceType Children Model")
	@Valid
	...
	@GraphQLField(description = "ResourceType Children Model")
	@JsonProperty(access = JsonProperty.Access.READ_ONLY)
	...
	@Schema(
		...
		defaultValue = "com.swork.core.resource.rest.dto.v1_0.ResourceType",
		name = "x-class-name"
	)
