...
public interface ResourceResource {
	...
	public Resource postResource(
			Long projectId, Long phaseId, Long workId, Resource resource)
		throws Exception;

	public HttpInvoker.HttpResponse postResourceHttpResponse(
			Long projectId, Long phaseId, Long workId, Resource resource)
		throws Exception;

	public void postResourceBatch(
			Long projectId, Long phaseId, Long workId, String callbackURL,
			Object object)
		throws Exception;

	public HttpInvoker.HttpResponse postResourceBatchHttpResponse(
			Long projectId, Long phaseId, Long workId, String callbackURL,
			Object object)
		throws Exception;
	...
	public HttpInvoker.HttpResponse deleteResourceHttpResponse(Long id)
		throws Exception;

	public void deleteResourceBatch(Long id, String callbackURL, Object object)
		throws Exception;

	public HttpInvoker.HttpResponse deleteResourceBatchHttpResponse(
			Long id, String callbackURL, Object object)
		throws Exception;

	public Resource getResource(Long id) throws Exception;

	public HttpInvoker.HttpResponse getResourceHttpResponse(Long id)
		throws Exception;

	public void putResource(Long id, Resource resource) throws Exception;

	public HttpInvoker.HttpResponse putResourceHttpResponse(
			Long id, Resource resource)
		throws Exception;

	public void putResourceBatch(Long id, String callbackURL, Object object)
		throws Exception;

	public HttpInvoker.HttpResponse putResourceBatchHttpResponse(
			Long id, String callbackURL, Object object)
		throws Exception;
	...
	public static class Builder {
		...
		public ResourceResource build() {
			return new ResourceResourceImpl(this);
		}
	...
	public static class ResourceResourceImpl implements ResourceResource {
		...
		public Page<Resource> getResourcePages(
			...
			try {
				return Page.of(content, ResourceSerDes::toDTO);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
		...
		public HttpInvoker.HttpResponse getResourcePagesHttpResponse(
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + "/o/swork/resource-rest/v1.0/resources");
		...
		public Resource postResource(
			...
			HttpInvoker.HttpResponse httpResponse = postResourceHttpResponse(
			...
			try {
				return ResourceSerDes.toDTO(content);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
		...
		public HttpInvoker.HttpResponse postResourceHttpResponse(
			...
			httpInvoker.body(resource.toString(), "application/json");
		...
		public HttpInvoker.HttpResponse postResourceBatchHttpResponse(
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port +
						"/o/swork/resource-rest/v1.0/resources/batch");
		...
		public void deleteResource(Long id) throws Exception {
			HttpInvoker.HttpResponse httpResponse = deleteResourceHttpResponse(
				id);
		...
		public HttpInvoker.HttpResponse deleteResourceHttpResponse(Long id)
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port +
						"/o/swork/resource-rest/v1.0/resources/{id}");
		...
		public void deleteResourceBatch(
				Long id, String callbackURL, Object object)
			throws Exception {

			HttpInvoker.HttpResponse httpResponse =
				deleteResourceBatchHttpResponse(id, callbackURL, object);
		...
		public Resource getResource(Long id) throws Exception {
			HttpInvoker.HttpResponse httpResponse = getResourceHttpResponse(id);
		...
		public void putResource(Long id, Resource resource) throws Exception {
			HttpInvoker.HttpResponse httpResponse = putResourceHttpResponse(
				id, resource);
		...
		public void putResourceBatch(Long id, String callbackURL, Object object)
			...
			HttpInvoker.HttpResponse httpResponse =
				putResourceBatchHttpResponse(id, callbackURL, object);
		...
		private ResourceResourceImpl(Builder builder) {
			_builder = builder;
		}

		private static final Logger _logger = Logger.getLogger(
			ResourceResource.class.getName());
