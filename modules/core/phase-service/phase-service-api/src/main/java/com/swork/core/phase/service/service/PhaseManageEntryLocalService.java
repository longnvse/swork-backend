...
/**
 * Provides the local service interface for PhaseManageEntry. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see PhaseManageEntryLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface PhaseManageEntryLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.swork.core.phase.service.service.impl.PhaseManageEntryLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the phase manage entry local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link PhaseManageEntryLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public PhaseManageEntry addPhaseManage(long phaseId, long accountId);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public PhaseManageEntry addPhaseManageEntry(
	...
	public PhaseManageEntry createPhaseManageEntry(long phaseManageId);
	...
	public PhaseManageEntry deletePhaseManageEntry(long phaseManageId)
		throws PortalException;
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public PhaseManageEntry deletePhaseManageEntry(
		PhaseManageEntry phaseManageEntry);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public PhaseManageEntry fetchPhaseManageEntry(long phaseManageId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<PhaseManageEntry> getPhaseManageEntries(int start, int end);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public PhaseManageEntry getPhaseManageEntry(long phaseManageId)
		throws PortalException;
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public PhaseManageEntry updatePhaseManageEntry(
		PhaseManageEntry phaseManageEntry);
