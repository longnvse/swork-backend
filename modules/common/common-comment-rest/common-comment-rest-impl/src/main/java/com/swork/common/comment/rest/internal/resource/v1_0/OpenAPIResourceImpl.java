...
@Generated("")
@OpenAPIDefinition(
	info = @Info(description = "CommonCommentRest REST API", license = @License(name = "Apache 2.0", url = "http://www.apache.org/licenses/LICENSE-2.0.html"), title = "CommonCommentRest", version = "v1.0")
)
@Path("/v1.0")
