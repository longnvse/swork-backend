package com.swork.common.comment.rest.client.resource.v1_0;
...
public interface CommentResource {
	...
	public void postCommentBatch(String callbackURL, Object object)
		throws Exception;

	public HttpInvoker.HttpResponse postCommentBatchHttpResponse(
	...
	public static class CommentResourceImpl implements CommentResource {
		...
		public HttpInvoker.HttpResponse getCommentPagesHttpResponse(
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port +
						"/o/swork/common-comment-rest/v1.0/comments");
		...
		public void postCommentBatch(String callbackURL, Object object)
			...
			HttpInvoker.HttpResponse httpResponse =
				postCommentBatchHttpResponse(callbackURL, object);
		...
		public HttpInvoker.HttpResponse postCommentBatchHttpResponse(
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port +
						"/o/swork/common-comment-rest/v1.0/comments/batch");
		...
		public HttpInvoker.HttpResponse deleteCommentHttpResponse(
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port +
						"/o/swork/common-comment-rest/v1.0/comments/{commentId}");
