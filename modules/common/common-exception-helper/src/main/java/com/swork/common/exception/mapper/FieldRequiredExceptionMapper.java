...
@Component(
        property = {
                ...
                "osgi.jaxrs.name=Swork.Common.Exception.SW_FieldRequiredException"
        },
        service = ExceptionMapper.class
)
public class FieldRequiredExceptionMapper
        extends BaseExceptionMapper<SW_FieldRequiredException> {

    private final String TITLE_MSG = "[SW] - Field Required Exception";

    @Override
    protected Problem getProblem(SW_FieldRequiredException exception) {
