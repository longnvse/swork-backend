 ...
 */
@Generated("")
@GraphQLName("DocumentBrief")
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "DocumentBrief")
public class DocumentBrief implements Serializable {

	public static DocumentBrief toDTO(String json) {
		return ObjectMapperUtil.readValue(DocumentBrief.class, json);
	}

	public static DocumentBrief unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(DocumentBrief.class, json);
	}
	...
	public String toString() {
		...
		if (documentBriefs != null) {
			...
			for (int i = 0; i < documentBriefs.length; i++) {
				sb.append(String.valueOf(documentBriefs[i]));

				if ((i + 1) < documentBriefs.length) {
					sb.append(", ");
				}
			}
	...
	@Schema(
		...
		defaultValue = "com.swork.common.file.rest.dto.v2_0.DocumentBrief",
		name = "x-class-name"
	)
