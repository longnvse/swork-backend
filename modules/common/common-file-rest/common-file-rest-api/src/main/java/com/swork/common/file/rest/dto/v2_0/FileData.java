 ...
 */
@Generated("")
@GraphQLName(description = "File Preview", value = "FileData")
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "FileData")
public class FileData implements Serializable {

	public static FileData toDTO(String json) {
		return ObjectMapperUtil.readValue(FileData.class, json);
	}

	public static FileData unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(FileData.class, json);
	}
	...
	@Schema(
		...
		defaultValue = "com.swork.common.file.rest.dto.v2_0.FileData",
		name = "x-class-name"
	)
