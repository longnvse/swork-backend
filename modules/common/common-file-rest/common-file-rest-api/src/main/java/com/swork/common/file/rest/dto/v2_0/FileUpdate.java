 ...
 */
@Generated("")
@GraphQLName("FileUpdate")
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "FileUpdate")
public class FileUpdate implements Serializable {

	public static FileUpdate toDTO(String json) {
		return ObjectMapperUtil.readValue(FileUpdate.class, json);
	}

	public static FileUpdate unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(FileUpdate.class, json);
	}
	...
	@Schema(
		...
		defaultValue = "com.swork.common.file.rest.dto.v2_0.FileUpdate",
		name = "x-class-name"
	)
