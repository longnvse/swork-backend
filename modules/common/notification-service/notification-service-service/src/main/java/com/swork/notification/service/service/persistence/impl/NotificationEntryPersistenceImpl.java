...
public class NotificationEntryPersistenceImpl
	...
	private FinderPath _finderPathWithPaginationFindByR_S_B;
	private FinderPath _finderPathWithoutPaginationFindByR_S_B;
	private FinderPath _finderPathCountByR_S_B;
	 ...
	 */
	@Override
	public List<NotificationEntry> findByR_S_B(
		long receiverId, String status, long businessId) {

		return findByR_S_B(
			receiverId, status, businessId, QueryUtil.ALL_POS,
	...
	public List<NotificationEntry> findByR_S_B(
		...
		return findByR_S_B(receiverId, status, businessId, start, end, null);
	}
	...
	public List<NotificationEntry> findByR_S_B(
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
			...
			if (useFinderCache) {
				finderPath = _finderPathWithoutPaginationFindByR_S_B;
				finderArgs = new Object[] {receiverId, status, businessId};
			}
		}
		else if (useFinderCache) {
			finderPath = _finderPathWithPaginationFindByR_S_B;
			finderArgs = new Object[] {
				receiverId, status, businessId, start, end, orderByComparator
			};
		}
		...
		if (list == null) {
			...
			sb.append(_FINDER_COLUMN_R_S_B_RECEIVERID_2);

			boolean bindStatus = false;

			if (status.isEmpty()) {
				sb.append(_FINDER_COLUMN_R_S_B_STATUS_3);
			}
			else {
				bindStatus = true;

				sb.append(_FINDER_COLUMN_R_S_B_STATUS_2);
			}

			sb.append(_FINDER_COLUMN_R_S_B_BUSINESSID_2);
	 ...
	 */
	@Override
	public NotificationEntry findByR_S_B_First(
			long receiverId, String status, long businessId,
			OrderByComparator<NotificationEntry> orderByComparator)
		throws NoSuchNotificationEntryException {

		NotificationEntry notificationEntry = fetchByR_S_B_First(
	 ...
	 */
	@Override
	public NotificationEntry fetchByR_S_B_First(
		long receiverId, String status, long businessId,
		OrderByComparator<NotificationEntry> orderByComparator) {

		List<NotificationEntry> list = findByR_S_B(
			receiverId, status, businessId, 0, 1, orderByComparator);
	 ...
	 */
	@Override
	public NotificationEntry findByR_S_B_Last(
			long receiverId, String status, long businessId,
			OrderByComparator<NotificationEntry> orderByComparator)
		throws NoSuchNotificationEntryException {

		NotificationEntry notificationEntry = fetchByR_S_B_Last(
			receiverId, status, businessId, orderByComparator);
	 ...
	 */
	@Override
	public NotificationEntry fetchByR_S_B_Last(
		long receiverId, String status, long businessId,
		OrderByComparator<NotificationEntry> orderByComparator) {

		int count = countByR_S_B(receiverId, status, businessId);
		...
		List<NotificationEntry> list = findByR_S_B(
			receiverId, status, businessId, count - 1, count,
			orderByComparator);
	 ...
	 */
	@Override
	public NotificationEntry[] findByR_S_B_PrevAndNext(
		...
		try {
			...
			array[0] = getByR_S_B_PrevAndNext(
				session, notificationEntry, receiverId, status, businessId,
				orderByComparator, true);

			array[1] = notificationEntry;

			array[2] = getByR_S_B_PrevAndNext(
				session, notificationEntry, receiverId, status, businessId,
				orderByComparator, false);
	...
	protected NotificationEntry getByR_S_B_PrevAndNext(
		Session session, NotificationEntry notificationEntry, long receiverId,
		String status, long businessId,
		OrderByComparator<NotificationEntry> orderByComparator,
		boolean previous) {
	 ...
	 */
	@Override
	public void removeByR_S_B(long receiverId, String status, long businessId) {
		for (NotificationEntry notificationEntry :
				findByR_S_B(
					receiverId, status, businessId, QueryUtil.ALL_POS,
					QueryUtil.ALL_POS, null)) {
	 ...
	 */
	@Override
	public int countByR_S_B(long receiverId, String status, long businessId) {
		status = Objects.toString(status, "");

		FinderPath finderPath = _finderPathCountByR_S_B;

		Object[] finderArgs = new Object[] {receiverId, status, businessId};
	...
	private static final String _FINDER_COLUMN_R_S_B_RECEIVERID_2 =
		"notificationEntry.receiverId = ? AND ";

	private static final String _FINDER_COLUMN_R_S_B_STATUS_2 =
		"notificationEntry.status = ? AND ";

	private static final String _FINDER_COLUMN_R_S_B_STATUS_3 =
		"(notificationEntry.status IS NULL OR notificationEntry.status = '') AND ";

	private static final String _FINDER_COLUMN_R_S_B_BUSINESSID_2 =
		"notificationEntry.businessId = ?";
	...
	public void activate() {
		...
		_finderPathWithPaginationFindByR_S_B = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByR_S_B",
			new String[] {
				Long.class.getName(), String.class.getName(),
				Long.class.getName(), Integer.class.getName(),
				Integer.class.getName(), OrderByComparator.class.getName()
			},
			new String[] {"receiverId", "status", "businessId"}, true);

		_finderPathWithoutPaginationFindByR_S_B = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByR_S_B",
			new String[] {
				Long.class.getName(), String.class.getName(),
				Long.class.getName()
			},
		...
		_finderPathCountByR_S_B = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByR_S_B",
			new String[] {
				Long.class.getName(), String.class.getName(),
				Long.class.getName()
			},
			new String[] {"receiverId", "status", "businessId"}, false);
