 ...
 */
@Generated("")
@GraphQLName(description = "Notification Model", value = "Notification")
...
public class Notification implements Serializable {
	...
	public String toString() {
		...
		if (receiverName != null) {
			...
			sb.append(_escape(receiverName));
	...
	@Schema(
		...
		defaultValue = "com.swork.notification.rest.dto.v2_0.Notification",
		name = "x-class-name"
	)
