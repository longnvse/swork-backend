...
public abstract class BaseNotificationResourceImpl
	implements EntityModelResource, NotificationResource,
			   VulcanBatchEngineTaskItemDelegate<Notification> {

	/**
	 * Invoke this method with the command line:
	 *
	 * curl -X 'GET' 'http://localhost:8080/o/swork/notification-rest/v2.0/notification-count'  -u 'test@liferay.com:test'
	 */
	...
	@javax.ws.rs.GET
	@javax.ws.rs.Path("/notification-count")
	@javax.ws.rs.Produces({"application/json", "application/xml"})
	@Override
	public Integer getCountNotification(
			@io.swagger.v3.oas.annotations.Parameter(hidden = true)
			@javax.ws.rs.QueryParam("category")
			String category,
			@io.swagger.v3.oas.annotations.Parameter(hidden = true)
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'GET' 'http://localhost:8080/o/swork/notification-rest/v2.0/notification'  -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Parameters(
		value = {
			@io.swagger.v3.oas.annotations.Parameter(
	...
	@javax.ws.rs.Path("/notification/approval-all-by-receiver/{receiverId}")
	@javax.ws.rs.Produces({"application/json", "application/xml"})
	@javax.ws.rs.PUT
	@Override
	public void approvalAllStatusByReceiver(
			...
			@javax.ws.rs.PathParam("receiverId")
			Long receiverId,
	...
	@javax.ws.rs.Consumes({"application/json", "application/xml"})
	@javax.ws.rs.Path("/notification/{id}")
	@javax.ws.rs.Produces({"application/json", "application/xml"})
	@javax.ws.rs.PUT
	@Override
	...
	public void create(
			java.util.Collection<Notification> notifications,
