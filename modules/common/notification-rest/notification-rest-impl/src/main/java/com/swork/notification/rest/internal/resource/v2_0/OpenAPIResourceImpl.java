...
@Generated("")
@OpenAPIDefinition(
	info = @Info(description = "Notification REST API", license = @License(name = "Apache 2.0", url = "http://www.apache.org/licenses/LICENSE-2.0.html"), title = "NotificationRest", version = "v2.0")
)
@Path("/v2.0")
	...
	private final Set<Class<?>> _resourceClasses = new HashSet<Class<?>>() {
		{
			...
			add(NotificationNewResourceImpl.class);
