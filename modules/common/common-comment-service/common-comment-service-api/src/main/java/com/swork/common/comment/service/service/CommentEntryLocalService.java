...
/**
 * Provides the local service interface for CommentEntry. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see CommentEntryLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface CommentEntryLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.swork.common.comment.service.service.impl.CommentEntryLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the comment entry local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link CommentEntryLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	@Indexable(type = IndexableType.REINDEX)
	public CommentEntry addCommentEntry(
	...
	@Indexable(type = IndexableType.REINDEX)
	public CommentEntry updateCommentEntry(
		long commentId, String content, ServiceContext serviceContext);
