...
/**
 * Provides the local service interface for ChecklistEntry. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see ChecklistEntryLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface ChecklistEntryLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.swork.checklist.service.service.impl.ChecklistEntryLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the checklist entry local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link ChecklistEntryLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public ChecklistEntry addChecklistEntry(ChecklistEntry checklistEntry);
	...
	public ChecklistEntry createChecklistEntry(long checklistId);
	...
	public ChecklistEntry deleteChecklistEntry(ChecklistEntry checklistEntry);
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public ChecklistEntry deleteChecklistEntry(long checklistId)
		throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ChecklistEntry fetchChecklistEntry(long checklistId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<ChecklistEntry> getChecklistEntries(int start, int end);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<ChecklistEntry> getChecklistEntriesByUuidAndCompanyId(
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ChecklistEntry getChecklistEntry(long checklistId)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ChecklistEntry getChecklistEntryByUuidAndGroupId(
			String uuid, long groupId)
		throws PortalException;
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public ChecklistEntry updateChecklistEntry(ChecklistEntry checklistEntry);
