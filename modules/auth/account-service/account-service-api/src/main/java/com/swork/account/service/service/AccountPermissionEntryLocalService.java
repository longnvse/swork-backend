...
/**
 * Provides the local service interface for AccountPermissionEntry. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see AccountPermissionEntryLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface AccountPermissionEntryLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.swork.account.service.service.impl.AccountPermissionEntryLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the account permission entry local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link AccountPermissionEntryLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public AccountPermissionEntry addAccountPermissionEntry(
			long permissionId, long accountId, ServiceContext serviceContext)
