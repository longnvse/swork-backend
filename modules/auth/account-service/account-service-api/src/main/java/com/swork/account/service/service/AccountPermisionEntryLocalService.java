...
/**
 * Provides the local service interface for AccountPermisionEntry. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see AccountPermisionEntryLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface AccountPermisionEntryLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.swork.account.service.service.impl.AccountPermisionEntryLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the account permision entry local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link AccountPermisionEntryLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public AccountPermisionEntry addAccountPermisionEntry(
		AccountPermisionEntry accountPermisionEntry);

	public AccountPermisionEntry addAccountPermisionEntry(
			long permisionId, long accountId, ServiceContext serviceContext)
	...
	public AccountPermisionEntry createAccountPermisionEntry(long id);
	...
	public AccountPermisionEntry deleteAccountPermisionEntry(
		AccountPermisionEntry accountPermisionEntry);
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public AccountPermisionEntry deleteAccountPermisionEntry(long id)
		throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public AccountPermisionEntry fetchAccountPermisionEntry(long id);
	...
	@Deprecated
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public AccountPermisionEntry fetchAccountPermisionEntryByReferenceCode(
		long companyId, String externalReferenceCode);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public AccountPermisionEntry fetchAccountPermisionEntryByUuidAndCompanyId(
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<AccountPermisionEntry> getAccountPermisionEntries(
		int start, int end);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public AccountPermisionEntry getAccountPermisionEntry(long id)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public AccountPermisionEntry getAccountPermisionEntryByUuidAndCompanyId(
			String uuid, long companyId)
		throws PortalException;
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public AccountPermisionEntry updateAccountPermisionEntry(
		AccountPermisionEntry accountPermisionEntry);
