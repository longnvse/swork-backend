...
/**
 * The base model interface for the PermissionEntry service. Represents a row in the &quot;SW_Permission&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation <code>com.swork.account.service.model.impl.PermissionEntryModelImpl</code> exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in <code>com.swork.account.service.model.impl.PermissionEntryImpl</code>.
 * </p>
 *
 ...
 */
@ProviderType
public interface PermissionEntryModel
	extends BaseModel<PermissionEntry>, ShardedModel {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. All methods that expect a permission entry model instance should use the {@link PermissionEntry} interface instead.
	 */
