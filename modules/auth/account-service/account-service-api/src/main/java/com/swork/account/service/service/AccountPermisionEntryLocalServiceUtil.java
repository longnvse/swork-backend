...
/**
 * Provides the local service utility for AccountPermisionEntry. This utility wraps
 * <code>com.swork.account.service.service.impl.AccountPermisionEntryLocalServiceImpl</code> and
 ...
 * @generated
 */
public class AccountPermisionEntryLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.swork.account.service.service.impl.AccountPermisionEntryLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static AccountPermisionEntry addAccountPermisionEntry(
		AccountPermisionEntry accountPermisionEntry) {

		return getService().addAccountPermisionEntry(accountPermisionEntry);
	}
	...
	public static AccountPermisionEntry addAccountPermisionEntry(
		...
		return getService().addAccountPermisionEntry(
	 ...
	 */
	public static AccountPermisionEntry createAccountPermisionEntry(long id) {
		return getService().createAccountPermisionEntry(id);
	}
	 ...
	 */
	public static AccountPermisionEntry deleteAccountPermisionEntry(
		AccountPermisionEntry accountPermisionEntry) {

		return getService().deleteAccountPermisionEntry(accountPermisionEntry);
	}
	 ...
	 */
	public static AccountPermisionEntry deleteAccountPermisionEntry(long id)
		throws PortalException {

		return getService().deleteAccountPermisionEntry(id);
	}
	...
	public static AccountPermisionEntry fetchAccountPermisionEntry(long id) {
		return getService().fetchAccountPermisionEntry(id);
	}
	 ...
	 */
	public static AccountPermisionEntry
		fetchAccountPermisionEntryByExternalReferenceCode(
			long companyId, String externalReferenceCode) {

		return getService().fetchAccountPermisionEntryByExternalReferenceCode(
	...
	public static AccountPermisionEntry
		...
		return getService().fetchAccountPermisionEntryByReferenceCode(
			companyId, externalReferenceCode);
	}
	...
	public static AccountPermisionEntry
		...
		return getService().fetchAccountPermisionEntryByUuidAndCompanyId(
			uuid, companyId);
	}
	 ...
	 */
	public static List<AccountPermisionEntry> getAccountPermisionEntries(
		int start, int end) {

		return getService().getAccountPermisionEntries(start, end);
	}
	 ...
	 */
	public static int getAccountPermisionEntriesCount() {
		return getService().getAccountPermisionEntriesCount();
	}
	 ...
	 * @throws PortalException if a account permision entry with the primary key could not be found
	 */
	public static AccountPermisionEntry getAccountPermisionEntry(long id)
		throws PortalException {

		return getService().getAccountPermisionEntry(id);
	}
	...
	public static AccountPermisionEntry
		...
		return getService().getAccountPermisionEntryByExternalReferenceCode(
			companyId, externalReferenceCode);
	}
	...
	public static AccountPermisionEntry
		...
		return getService().getAccountPermisionEntryByUuidAndCompanyId(
			uuid, companyId);
	}
	 ...
	 */
	public static AccountPermisionEntry updateAccountPermisionEntry(
		AccountPermisionEntry accountPermisionEntry) {

		return getService().updateAccountPermisionEntry(accountPermisionEntry);
	}

	public static AccountPermisionEntryLocalService getService() {
		return _service;
	}

	private static volatile AccountPermisionEntryLocalService _service;
