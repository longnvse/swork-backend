...
import com.swork.account.service.model.AccountEntryTable;
import com.swork.account.service.model.impl.AccountEntryImpl;
import com.swork.account.service.model.impl.AccountEntryModelImpl;
import com.swork.account.service.service.persistence.AccountEntryPersistence;
import com.swork.account.service.service.persistence.AccountEntryUtil;
...
public class AccountEntryPersistenceImpl
	...
	public AccountEntry findByUsername(String username)
		...
		AccountEntry accountEntry = fetchByUsername(username);
	...
	public AccountEntry removeByUsername(String username)
		...
		AccountEntry accountEntry = findByUsername(username);
