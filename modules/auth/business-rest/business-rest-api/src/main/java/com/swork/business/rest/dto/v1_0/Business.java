package com.swork.business.rest.dto.v1_0;
 ...
 */
@Generated("")
@GraphQLName("Business")
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "Business")
public class Business implements Serializable {

	public static Business toDTO(String json) {
		return ObjectMapperUtil.readValue(Business.class, json);
	}

	public static Business unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(Business.class, json);
	}
	...
	public String toString() {
		...
		if (businessAddress != null) {
			...
			sb.append(_escape(businessAddress));
		...
		if (fieldOperations != null) {
			...
			sb.append(_escape(fieldOperations));
	...
	@Schema(
		...
		defaultValue = "com.swork.business.rest.dto.v1_0.Business",
		name = "x-class-name"
	)
