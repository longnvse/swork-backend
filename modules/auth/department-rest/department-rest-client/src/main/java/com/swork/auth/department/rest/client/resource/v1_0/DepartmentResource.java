package com.swork.auth.department.rest.client.resource.v1_0;
...
import com.swork.auth.department.rest.client.problem.Problem;
...
public interface DepartmentResource {
	...
	public HttpInvoker.HttpResponse getDepartmentPagesHttpResponse(
			String search, String filterString, Pagination pagination,
			String sortString)
		throws Exception;
	...
	public HttpInvoker.HttpResponse deleteDepartmentHttpResponse(Long id)
		throws Exception;
	...
	public HttpInvoker.HttpResponse getByIdHttpResponse(Long id)
		throws Exception;

	public Department updateDepartment(Long id, Department department)
		throws Exception;

	public HttpInvoker.HttpResponse updateDepartmentHttpResponse(
	...
	public static class DepartmentResourceImpl implements DepartmentResource {
		...
		public Page<Department> getDepartmentPages(
			...
			HttpInvoker.HttpResponse httpResponse =
				getDepartmentPagesHttpResponse(
		...
		public void deleteDepartment(Long id) throws Exception {
			HttpInvoker.HttpResponse httpResponse =
				deleteDepartmentHttpResponse(id);
		...
		public void deleteDepartmentBatch(
			...
			HttpInvoker.HttpResponse httpResponse =
				deleteDepartmentBatchHttpResponse(id, callbackURL, object);
		...
		public Department getById(Long id) throws Exception {
			HttpInvoker.HttpResponse httpResponse = getByIdHttpResponse(id);
		...
		public Department updateDepartment(Long id, Department department)
			...
			HttpInvoker.HttpResponse httpResponse =
				updateDepartmentHttpResponse(id, department);
