...
public interface DepartmentResource {
	...
	public HttpInvoker.HttpResponse getDepartmentHttpResponse(Long id)
		throws Exception;
	...
	public void putDepartmentBatch(Long id, String callbackURL, Object object)
		throws Exception;
	...
	public static class DepartmentResourceImpl implements DepartmentResource {
		...
		public void putDepartmentBatch(
				Long id, String callbackURL, Object object)
			throws Exception {

			HttpInvoker.HttpResponse httpResponse =
				putDepartmentBatchHttpResponse(id, callbackURL, object);
