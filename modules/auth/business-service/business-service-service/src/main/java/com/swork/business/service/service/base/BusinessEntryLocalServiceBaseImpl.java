...
package com.swork.business.service.service.base;
...
import com.swork.business.service.service.BusinessEntryLocalServiceUtil;
...
/**
 * Provides the base implementation for the business entry local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.swork.business.service.service.impl.BusinessEntryLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.swork.business.service.service.impl.BusinessEntryLocalServiceImpl
 * @generated
 */
public abstract class BusinessEntryLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, BusinessEntryLocalService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>BusinessEntryLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>BusinessEntryLocalServiceUtil</code>.
	 */
	...
	public BusinessEntry addBusinessEntry(BusinessEntry businessEntry) {
		...
		return businessEntryPersistence.update(businessEntry);
	}
	...
	public BusinessEntry createBusinessEntry(long businessId) {
		return businessEntryPersistence.create(businessId);
	}
	...
	public BusinessEntry deleteBusinessEntry(long businessId)
		...
		return businessEntryPersistence.remove(businessId);
	}
	...
	public BusinessEntry deleteBusinessEntry(BusinessEntry businessEntry) {
		return businessEntryPersistence.remove(businessEntry);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return businessEntryPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			BusinessEntry.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return businessEntryPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return businessEntryPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return businessEntryPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return businessEntryPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public BusinessEntry fetchBusinessEntry(long businessId) {
		return businessEntryPersistence.fetchByPrimaryKey(businessId);
	}
	...
	public BusinessEntry fetchBusinessEntryByUuidAndGroupId(
		...
		return businessEntryPersistence.fetchByUUID_G(uuid, groupId);
	}
	...
	public BusinessEntry fetchBusinessEntryByExternalReferenceCode(
		...
		return businessEntryPersistence.fetchByC_ERC(
	...
	public BusinessEntry fetchBusinessEntryByReferenceCode(
		...
		return fetchBusinessEntryByExternalReferenceCode(
			companyId, externalReferenceCode);
	}
	...
	public BusinessEntry getBusinessEntryByExternalReferenceCode(
		...
		return businessEntryPersistence.findByC_ERC(
			companyId, externalReferenceCode);
	}
	...
	public BusinessEntry getBusinessEntry(long businessId)
		...
		return businessEntryPersistence.findByPrimaryKey(businessId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(businessEntryLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(BusinessEntry.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("businessId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setBaseLocalService(
			businessEntryLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(BusinessEntry.class);

		indexableActionableDynamicQuery.setPrimaryKeyPropertyName("businessId");
	...
	public ExportActionableDynamicQuery getExportActionableDynamicQuery(
		...
		exportActionableDynamicQuery.setPerformActionMethod(
			new ActionableDynamicQuery.PerformActionMethod<BusinessEntry>() {

				@Override
				public void performAction(BusinessEntry businessEntry)
					throws PortalException {

					StagedModelDataHandlerUtil.exportStagedModel(
						portletDataContext, businessEntry);
				}
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return businessEntryPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return businessEntryLocalService.deleteBusinessEntry(
			(BusinessEntry)persistedModel);
	}

	@Override
	public BasePersistence<BusinessEntry> getBasePersistence() {
		return businessEntryPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return businessEntryPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<BusinessEntry> getBusinessEntriesByUuidAndCompanyId(
		...
		return businessEntryPersistence.findByUuid_C(uuid, companyId);
	}
	...
	public List<BusinessEntry> getBusinessEntriesByUuidAndCompanyId(
		...
		return businessEntryPersistence.findByUuid_C(
	...
	public BusinessEntry getBusinessEntryByUuidAndGroupId(
		...
		return businessEntryPersistence.findByUUID_G(uuid, groupId);
	}
	...
	public List<BusinessEntry> getBusinessEntries(int start, int end) {
		return businessEntryPersistence.findAll(start, end);
	}
	...
	public int getBusinessEntriesCount() {
		return businessEntryPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			BusinessEntryLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		businessEntryLocalService = (BusinessEntryLocalService)aopProxy;

		_setLocalServiceUtilService(businessEntryLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return BusinessEntryLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = businessEntryPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field = BusinessEntryLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, businessEntryLocalService);
		}
	...
	protected BusinessEntryLocalService businessEntryLocalService;

	@Reference
	protected BusinessEntryPersistence businessEntryPersistence;
