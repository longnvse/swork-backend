...
public abstract class BaseAccountResourceTestCase {
	...
	protected List<GraphQLField> getGraphQLFields() throws Exception {
		...
		for (java.lang.reflect.Field field :
				getDeclaredFields(
					com.swork.account.rest.dto.v1_0.Account.class)) {
		...
		for (String additionalAssertFieldName :
			...
			if (Objects.equals("address", additionalAssertFieldName)) {
				if (!Objects.deepEquals(
						account1.getAddress(), account2.getAddress())) {
	...
	protected String getFilterString(
		...
		if (entityFieldName.equals("createDate")) {
			if (operator.equals("between")) {
				...
				sb.append(
					_dateFormat.format(
						DateUtils.addSeconds(account.getCreateDate(), -2)));
				sb.append(" and ");
				sb.append(entityFieldName);
				sb.append(" lt ");
				sb.append(
				...
				sb.append(_dateFormat.format(account.getCreateDate()));
			}
	...
	@Inject
	private com.swork.account.rest.resource.v1_0.AccountResource
		_accountResource;
