...
@Generated("")
@OpenAPIDefinition(
	info = @Info(description = "AccountRest REST API", license = @License(name = "Apache 2.0", url = "http://www.apache.org/licenses/LICENSE-2.0.html"), title = "AccountRest", version = "v1.0")
)
@Path("/v1.0")
	...
	private final Set<Class<?>> _resourceClasses = new HashSet<Class<?>>() {
		{
			...
			add(AccountPermisionResourceImpl.class);
