...
public interface AccountResource {
	...
	public HttpInvoker.HttpResponse getPermissionDetailByIdHttpResponse(Long id)
		throws Exception;
	...
	public static class AccountResourceImpl implements AccountResource {
		...
		public Page<PermissionDetail> getPermissionDetailById(Long id)
			...
			HttpInvoker.HttpResponse httpResponse =
				getPermissionDetailByIdHttpResponse(id);
			...
			try {
				return Page.of(content, PermissionDetailSerDes::toDTO);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
		...
		public HttpInvoker.HttpResponse getPermissionDetailByIdHttpResponse(
				Long id)
			throws Exception {
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port +
						"/o/account-rest/v1.0/get-action-code/{id}");
