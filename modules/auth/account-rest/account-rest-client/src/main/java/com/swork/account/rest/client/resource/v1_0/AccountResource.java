package com.swork.account.rest.client.resource.v1_0;
...
import com.swork.account.rest.client.problem.Problem;
...
public interface AccountResource {
	...
	public HttpInvoker.HttpResponse approvalAccountHttpResponse(
			Long accountId, String status)
		throws Exception;

	public Account getAccountInfo() throws Exception;

	public HttpInvoker.HttpResponse getAccountInfoHttpResponse()
		throws Exception;

	public void patchAccountPassword(ChangePassword changePassword)
		throws Exception;

	public HttpInvoker.HttpResponse patchAccountPasswordHttpResponse(
			ChangePassword changePassword)
		throws Exception;

	public void putAccountInfo(Account account) throws Exception;

	public HttpInvoker.HttpResponse putAccountInfoHttpResponse(Account account)
		throws Exception;

	public void resetPassword(ResetPassword resetPassword) throws Exception;

	public HttpInvoker.HttpResponse resetPasswordHttpResponse(
			ResetPassword resetPassword)
		throws Exception;

	public void updateAvatar(Account account, Map<String, File> multipartFiles)
		throws Exception;

	public HttpInvoker.HttpResponse updateAvatarHttpResponse(
			Account account, Map<String, File> multipartFiles)
		throws Exception;

	public Page<Account> getListAccount(Long[] accountIds) throws Exception;

	public HttpInvoker.HttpResponse getListAccountHttpResponse(
			Long[] accountIds)
		throws Exception;
	...
	public static class AccountResourceImpl implements AccountResource {
		...
		public void approvalAccount(Long accountId, String status)
			throws Exception {

			HttpInvoker.HttpResponse httpResponse = approvalAccountHttpResponse(
				accountId, status);
		...
		public HttpInvoker.HttpResponse approvalAccountHttpResponse(
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port +
						"/o/swork/account-rest/v1.0/accounts/approval/{accountId}");
		...
		public HttpInvoker.HttpResponse getAccountInfoHttpResponse()
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port +
						"/o/swork/account-rest/v1.0/accounts/account-info");
		...
		public void patchAccountPassword(ChangePassword changePassword)
			...
			HttpInvoker.HttpResponse httpResponse =
				patchAccountPasswordHttpResponse(changePassword);
		...
		public HttpInvoker.HttpResponse patchAccountPasswordHttpResponse(
			...
			httpInvoker.body(changePassword.toString(), "application/json");
		...
		public void putAccountInfo(Account account) throws Exception {
			HttpInvoker.HttpResponse httpResponse = putAccountInfoHttpResponse(
				account);
		...
		public HttpInvoker.HttpResponse putAccountInfoHttpResponse(
				Account account)
			throws Exception {
		...
		public void resetPassword(ResetPassword resetPassword)
			...
			HttpInvoker.HttpResponse httpResponse = resetPasswordHttpResponse(
				resetPassword);
		...
		public HttpInvoker.HttpResponse resetPasswordHttpResponse(
			...
			httpInvoker.body(resetPassword.toString(), "application/json");
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port +
						"/o/swork/account-rest/v1.0/accounts/reset-password");
		...
		public void updateAvatar(
			...
			HttpInvoker.HttpResponse httpResponse = updateAvatarHttpResponse(
				account, multipartFiles);
		...
		public HttpInvoker.HttpResponse updateAvatarHttpResponse(
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port +
						"/o/swork/account-rest/v1.0/accounts/account-info/avatar");
		...
		public Page<Account> getListAccount(Long[] accountIds)
			throws Exception {

			HttpInvoker.HttpResponse httpResponse = getListAccountHttpResponse(
				accountIds);
		...
		public HttpInvoker.HttpResponse getListAccountHttpResponse(
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port +
						"/o/swork/account-rest/v1.0/accounts/account-list");
