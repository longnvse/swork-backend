 ...
 */
@Generated("")
@GraphQLName(description = "AccountPermision model", value = "AccountPermision")
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "AccountPermision")
public class AccountPermision implements Serializable {

	public static AccountPermision toDTO(String json) {
		return ObjectMapperUtil.readValue(AccountPermision.class, json);
	}

	public static AccountPermision unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(AccountPermision.class, json);
	}
	...
	@Schema(
		...
		defaultValue = "com.swork.account.rest.dto.v1_0.AccountPermision",
		name = "x-class-name"
	)
