...
@Generated("")
@GraphQLName(
	description = "AccountPermission model", value = "PermissionDetail"
)
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "PermissionDetail")
public class PermissionDetail implements Serializable {

	public static PermissionDetail toDTO(String json) {
		return ObjectMapperUtil.readValue(PermissionDetail.class, json);
	}

	public static PermissionDetail unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(PermissionDetail.class, json);
	}
	...
	@Schema(
		...
		defaultValue = "com.swork.account.rest.dto.v1_0.PermissionDetail",
		name = "x-class-name"
	)
