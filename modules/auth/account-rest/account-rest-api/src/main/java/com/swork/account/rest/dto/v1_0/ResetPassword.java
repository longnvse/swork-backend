...
public class ResetPassword implements Serializable {
	...
	public static ResetPassword toDTO(String json) {
		return ObjectMapperUtil.readValue(ResetPassword.class, json);
	}

	public static ResetPassword unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(ResetPassword.class, json);
	}
	...
	@Schema(
		...
		defaultValue = "com.swork.account.rest.dto.v1_0.ResetPassword",
		name = "x-class-name"
	)
