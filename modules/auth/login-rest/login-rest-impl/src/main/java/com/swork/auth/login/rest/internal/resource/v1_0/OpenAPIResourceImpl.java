...
@Generated("")
@OpenAPIDefinition(
	info = @Info(description = "LoginRest REST API", license = @License(name = "Apache 2.0", url = "http://www.apache.org/licenses/LICENSE-2.0.html"), title = "LoginRest", version = "v1.0")
)
@Path("/v1.0")
