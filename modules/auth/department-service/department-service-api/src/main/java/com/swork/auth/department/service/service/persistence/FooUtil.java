...
public class FooUtil {
	...
	public static Foo findByUuid_First(
		...
		throws com.swork.auth.department.service.exception.NoSuchFooException {
	 ...
	 * @throws NoSuchFooException if a foo with the primary key could not be found
	 */
	public static Foo remove(long id)
		throws com.swork.auth.department.service.exception.NoSuchFooException {
	 ...
	 * @throws NoSuchFooException if a foo with the primary key could not be found
	 */
	public static Foo findByPrimaryKey(long id)
		throws com.swork.auth.department.service.exception.NoSuchFooException {
	 ...
	 */
	public static Foo fetchByPrimaryKey(long id) {
