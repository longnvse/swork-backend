 ...
 * <code>com.swork.auth.department.service.service.impl.FooLocalServiceImpl</code> and
...
public class FooLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.swork.auth.department.service.service.impl.FooLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 * @return the new foo
	 */
	public static Foo createFoo(long id) {
		return getService().createFoo(id);
	}
	 ...
	 */
	public static Foo deleteFoo(long id) throws PortalException {
		return getService().deleteFoo(id);
	}
	...
	public static Foo fetchFoo(long id) {
		return getService().fetchFoo(id);
	}
