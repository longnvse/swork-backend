...
package com.swork.auth.department.service.service.base;
...
/**
 * Provides the base implementation for the department entry local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.swork.auth.department.service.service.impl.DepartmentEntryLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.swork.auth.department.service.service.impl.DepartmentEntryLocalServiceImpl
 * @generated
 */
public abstract class DepartmentEntryLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, DepartmentEntryLocalService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>DepartmentEntryLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>DepartmentEntryLocalServiceUtil</code>.
	 */
	...
	public DepartmentEntry addDepartmentEntry(DepartmentEntry departmentEntry) {
		...
		return departmentEntryPersistence.update(departmentEntry);
	}
	...
	public DepartmentEntry createDepartmentEntry(long departmentId) {
		return departmentEntryPersistence.create(departmentId);
	}
	...
	public DepartmentEntry deleteDepartmentEntry(long departmentId)
		...
		return departmentEntryPersistence.remove(departmentId);
	}
	...
	public DepartmentEntry deleteDepartmentEntry(
		...
		return departmentEntryPersistence.remove(departmentEntry);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return departmentEntryPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			DepartmentEntry.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return departmentEntryPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return departmentEntryPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return departmentEntryPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return departmentEntryPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public DepartmentEntry fetchDepartmentEntry(long departmentId) {
		return departmentEntryPersistence.fetchByPrimaryKey(departmentId);
	}
	...
	public DepartmentEntry fetchDepartmentEntryByUuidAndGroupId(
		...
		return departmentEntryPersistence.fetchByUUID_G(uuid, groupId);
	}
	...
	public DepartmentEntry fetchDepartmentEntryByExternalReferenceCode(
		...
		return departmentEntryPersistence.fetchByC_ERC(
	...
	public DepartmentEntry fetchDepartmentEntryByReferenceCode(
		...
		return fetchDepartmentEntryByExternalReferenceCode(
			companyId, externalReferenceCode);
	}
	...
	public DepartmentEntry getDepartmentEntryByExternalReferenceCode(
		...
		return departmentEntryPersistence.findByC_ERC(
			companyId, externalReferenceCode);
	}
	...
	public DepartmentEntry getDepartmentEntry(long departmentId)
		...
		return departmentEntryPersistence.findByPrimaryKey(departmentId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(departmentEntryLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(DepartmentEntry.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(DepartmentEntry.class);
	...
	public ExportActionableDynamicQuery getExportActionableDynamicQuery(
		...
		exportActionableDynamicQuery.setPerformActionMethod(
			new ActionableDynamicQuery.PerformActionMethod<DepartmentEntry>() {

				@Override
				public void performAction(DepartmentEntry departmentEntry)
					throws PortalException {

					StagedModelDataHandlerUtil.exportStagedModel(
						portletDataContext, departmentEntry);
				}
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return departmentEntryPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return departmentEntryLocalService.deleteDepartmentEntry(
			(DepartmentEntry)persistedModel);
	}

	@Override
	public BasePersistence<DepartmentEntry> getBasePersistence() {
		return departmentEntryPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return departmentEntryPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<DepartmentEntry> getDepartmentEntriesByUuidAndCompanyId(
		...
		return departmentEntryPersistence.findByUuid_C(uuid, companyId);
	}
	...
	public List<DepartmentEntry> getDepartmentEntriesByUuidAndCompanyId(
		...
		return departmentEntryPersistence.findByUuid_C(
	...
	public DepartmentEntry getDepartmentEntryByUuidAndGroupId(
		...
		return departmentEntryPersistence.findByUUID_G(uuid, groupId);
	}
	...
	public List<DepartmentEntry> getDepartmentEntries(int start, int end) {
		return departmentEntryPersistence.findAll(start, end);
	}
	...
	public int getDepartmentEntriesCount() {
		return departmentEntryPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			DepartmentEntryLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		departmentEntryLocalService = (DepartmentEntryLocalService)aopProxy;

		_setLocalServiceUtilService(departmentEntryLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return DepartmentEntryLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = departmentEntryPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field =
				DepartmentEntryLocalServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, departmentEntryLocalService);
		}
	...
	@Reference
	protected DepartmentEntryPersistence departmentEntryPersistence;
