...
import com.swork.auth.department.service.exception.NoSuchFooException;
...
import com.swork.auth.department.service.service.persistence.FooPersistence;
import com.swork.auth.department.service.service.persistence.FooUtil;
import com.swork.auth.department.service.service.persistence.impl.constants.FOOPersistenceConstants;
...
public class FooPersistenceImpl
	 ...
	 *
	 * @param id the primary key of the current foo
	 * @param uuid the uuid
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	...
	public Foo[] findByUuid_PrevAndNext(
			long id, String uuid, OrderByComparator<Foo> orderByComparator)
		throws NoSuchFooException {

		uuid = Objects.toString(uuid, "");

		Foo foo = findByPrimaryKey(id);
	 ...
	 */
	@Override
	public Foo remove(long id) throws NoSuchFooException {
	 ...
	 */
	@Override
	public Foo findByPrimaryKey(long id) throws NoSuchFooException {
	 ...
	 */
	@Override
	public Foo fetchByPrimaryKey(long id) {
