...
import com.swork.auth.department.service.service.FooLocalService;
import com.swork.auth.department.service.service.FooLocalServiceUtil;
 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.swork.auth.department.service.service.impl.FooLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.swork.auth.department.service.service.impl.FooLocalServiceImpl
 * @generated
 */
public abstract class FooLocalServiceBaseImpl
	...
	public Foo createFoo(long id) {
		return fooPersistence.create(id);
	}
	...
	public Foo deleteFoo(long id) throws PortalException {
		return fooPersistence.remove(id);
	}
	...
	public Foo fetchFoo(long id) {
		return fooPersistence.fetchByPrimaryKey(id);
	}
	...
	public Foo getFoo(long id) throws PortalException {
		return fooPersistence.findByPrimaryKey(id);
	}
