...
package com.swork.service.service.persistence;
...
public class PetEntryUtil {
	...
	public static PetEntry findByUuid_First(
		...
		throws com.swork.service.exception.NoSuchPetEntryException {
	 ...
	 * @return the matching pet entries
	 */
	public static List<PetEntry> findByPrice(Long price) {
	 ...
	 * @return the range of matching pet entries
	 */
	public static List<PetEntry> findByPrice(Long price, int start, int end) {
	 ...
	 * @return the ordered range of matching pet entries
	 */
	public static List<PetEntry> findByPrice(
	 ...
	 * @throws NoSuchPetEntryException if a matching pet entry could not be found
	 */
	public static PetEntry findByPrice_First(
	 ...
	 * @return the first matching pet entry, or <code>null</code> if a matching pet entry could not be found
	 */
	public static PetEntry fetchByPrice_First(
		Long price, OrderByComparator<PetEntry> orderByComparator) {
	 ...
	 * @throws NoSuchPetEntryException if a matching pet entry could not be found
	 */
	public static PetEntry findByPrice_Last(
			Long price, OrderByComparator<PetEntry> orderByComparator)
		throws com.swork.service.exception.NoSuchPetEntryException {
	 ...
	 * @return the last matching pet entry, or <code>null</code> if a matching pet entry could not be found
	 */
	public static PetEntry fetchByPrice_Last(
		Long price, OrderByComparator<PetEntry> orderByComparator) {
	 ...
	 * @throws NoSuchPetEntryException if a pet entry with the primary key could not be found
	 */
	public static PetEntry[] findByPrice_PrevAndNext(
			long petId, Long price,
			OrderByComparator<PetEntry> orderByComparator)
		throws com.swork.service.exception.NoSuchPetEntryException {

		return getPersistence().findByPrice_PrevAndNext(
			petId, price, orderByComparator);
	}
	 ...
	 * @param price the price
	 */
	public static void removeByPrice(Long price) {
	 ...
	 * @return the number of matching pet entries
	 */
	public static int countByPrice(Long price) {
