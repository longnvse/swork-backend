...
package com.swork.service.service.persistence.impl;
...
import com.swork.service.exception.NoSuchPetEntryException;
import com.swork.service.model.PetEntry;
import com.swork.service.model.PetEntryTable;
import com.swork.service.model.impl.PetEntryImpl;
import com.swork.service.model.impl.PetEntryModelImpl;
import com.swork.service.service.persistence.PetEntryPersistence;
import com.swork.service.service.persistence.PetEntryUtil;
import com.swork.service.service.persistence.impl.constants.SW_PETPersistenceConstants;
...
public class PetEntryPersistenceImpl
	...
	/**
	 * Returns all the pet entries where price = &#63;.
	 *
	 * @param price the price
	 * @return the matching pet entries
	 */
	@Override
	public List<PetEntry> findByPrice(Long price) {
		return findByPrice(price, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}

	/**
	 * Returns a range of all the pet entries where price = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent, then the query will include the default ORDER BY logic from <code>PetEntryModelImpl</code>.
	 * </p>
	 ...
	 */
	@Override
	public List<PetEntry> findByPrice(Long price, int start, int end) {
		return findByPrice(price, start, end, null);
	}

	/**
	 * Returns an ordered range of all the pet entries where price = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent, then the query will include the default ORDER BY logic from <code>PetEntryModelImpl</code>.
	 * </p>
	 ...
	 */
	@Override
	public List<PetEntry> findByPrice(
	...
	public List<PetEntry> findByPrice(
		...
		if (useFinderCache) {
			...
			if ((list != null) && !list.isEmpty()) {
				for (PetEntry petEntry : list) {
					if (!Objects.equals(price, petEntry.getPrice())) {
						list = null;
	...
	/**
	 * Returns the first pet entry in the ordered set where price = &#63;.
	 *
	 * @param price the price
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 * @return the first matching pet entry
	 ...
	 */
	@Override
	public PetEntry findByPrice_First(
			Long price, OrderByComparator<PetEntry> orderByComparator)
		throws NoSuchPetEntryException {

		PetEntry petEntry = fetchByPrice_First(price, orderByComparator);
	 ...
	 */
	@Override
	public PetEntry fetchByPrice_First(
		Long price, OrderByComparator<PetEntry> orderByComparator) {

		List<PetEntry> list = findByPrice(price, 0, 1, orderByComparator);
	...
	/**
	 * Returns the last pet entry in the ordered set where price = &#63;.
	 *
	 * @param price the price
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 * @return the last matching pet entry
	 ...
	 */
	@Override
	public PetEntry findByPrice_Last(
			Long price, OrderByComparator<PetEntry> orderByComparator)
		throws NoSuchPetEntryException {

		PetEntry petEntry = fetchByPrice_Last(price, orderByComparator);
	 ...
	 */
	@Override
	public PetEntry fetchByPrice_Last(
		Long price, OrderByComparator<PetEntry> orderByComparator) {
		...
		List<PetEntry> list = findByPrice(
	...
	/**
	 * Returns the pet entries before and after the current pet entry in the ordered set where price = &#63;.
	 *
	 * @param petId the primary key of the current pet entry
	 * @param price the price
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 ...
	 */
	@Override
	public PetEntry[] findByPrice_PrevAndNext(
			long petId, Long price,
			OrderByComparator<PetEntry> orderByComparator)
		throws NoSuchPetEntryException {
		...
		try {
			...
			array[0] = getByPrice_PrevAndNext(
				session, petEntry, price, orderByComparator, true);

			array[1] = petEntry;

			array[2] = getByPrice_PrevAndNext(
				session, petEntry, price, orderByComparator, false);
	...
	protected PetEntry getByPrice_PrevAndNext(
		Session session, PetEntry petEntry, Long price,
		OrderByComparator<PetEntry> orderByComparator, boolean previous) {
	...
	/**
	 * Removes all the pet entries where price = &#63; from the database.
	 *
	 * @param price the price
	 */
	@Override
	public void removeByPrice(Long price) {
		for (PetEntry petEntry :
				findByPrice(
	...
	/**
	 * Returns the number of pet entries where price = &#63;.
	 *
	 * @param price the price
	 * @return the number of matching pet entries
	 */
	@Override
	public int countByPrice(Long price) {
	...
	public void activate() {
		...
		_finderPathWithoutPaginationFindByPrice = new FinderPath(
			...
			new String[] {Long.class.getName()}, new String[] {"price"}, true);

		_finderPathCountByPrice = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByPrice",
			new String[] {Long.class.getName()}, new String[] {"price"}, false);
	...
	@Override
	@Reference(
		target = SW_PETPersistenceConstants.SERVICE_CONFIGURATION_FILTER,
		unbind = "-"
	)
	...
	@Override
	@Reference(
		target = SW_PETPersistenceConstants.ORIGIN_BUNDLE_SYMBOLIC_NAME_FILTER,
		unbind = "-"
	)
